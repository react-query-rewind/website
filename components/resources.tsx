    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20"name="team">
          ...
          <div>
            ...
            <div className="max-w-sm mx-auto sm:max-w-none grid gap-12 sm:grid-cols-2 md:grid-cols-4 sm:gap-x-6 sm:gap-y-8 items-start">
              ...
              >
              {/* 2nd Box */}
{/* <div className="font-uncut-sans text-xl text-gray-100 font-semibold">J href="#0" */}
