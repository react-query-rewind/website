...
const DropDownMenu: React.FC<DropdownProps> = ({ label, items }) => {
  ...
  return (
    <div ref={dropdownRef} className="relative inline-block text-left">
      ...
      {isOpen && (
        <ul className="absolute left-0 mt-2 w-32 rounded-md shadow-lg bg-gradient-to-b from-gray-800 to-gray-900 opacity-80 round ring-1 ring-black ring-opacity-5 focus:outline-none">
